...
execute if score #korvath_village ae_settlement matches 2 run summon armor_stand 1003 70 0 {Invisible:0b,CustomName:'{"text":"Korvath Sentinel","color":"dark_red"}',CustomNameVisible:1b,Tags:["korvath.sentinel"],ArmorItems:[{id:"minecraft:iron_boots",count:1},{id:"minecraft:iron_leggings",count:1},{id:"minecraft:leather_chestplate",count:1},{id:"minecraft:iron_helmet",count:1}],HandItems:[{id:"minecraft:iron_sword",count:1},{}]}
execute if score #korvath_village ae_settlement matches 2 run summon armor_stand 997 70 0 {Invisible:0b,CustomName:'{"text":"Korvath Sentinel","color":"dark_red"}',CustomNameVisible:1b,Tags:["korvath.sentinel"],ArmorItems:[{id:"minecraft:iron_boots",count:1},{id:"minecraft:iron_leggings",count:1},{id:"minecraft:leather_chestplate",count:1},{id:"minecraft:iron_helmet",count:1}],HandItems:[{id:"minecraft:iron_sword",count:1},{}]}
