...
execute if score #korvath_village ae_settlement matches 2 run setblock 1003 70 0 armor_stand{Invisible:0b,CustomName:'{"text":"Korvath Sentinel","color":"dark_red"}',CustomNameVisible:1b,Tags:["korvath.sentinel"],ArmorItems:[{id:"minecraft:iron_boots",count:1},{id:"minecraft:iron_leggings",count:1},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":{"rgb":11141120,"show_in_tooltip":false}}},{id:"minecraft:iron_helmet",count:1}],HandItems:[{id:"minecraft:iron_sword",count:1},{}]} replace
