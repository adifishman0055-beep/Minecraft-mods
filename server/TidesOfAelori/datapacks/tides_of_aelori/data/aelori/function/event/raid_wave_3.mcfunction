...
title @a title {"text":"BOSS WAVE","color":"dark_red","bold":true}
title @a subtitle {"text":"Korvathi Raider Captain","color":"red"}
...
effect give @e[tag=aelori.raider_boss] minecraft:glowing 999999 0 true
