...
setblock 1000 71 0 chest{Items:[{id:"minecraft:emerald",count:16,Slot:0b},{id:"minecraft:iron_ingot",count:16,Slot:1b},{id:"minecraft:golden_apple",count:4,Slot:2b},{id:"minecraft:bread",count:24,Slot:3b},{id:"minecraft:arrow",count:64,Slot:4b}]} replace
...
execute as @a[scores={ae_faction=2,ae_quest=7}] run function aelori:quest/korvath/kq07_repel_attack
