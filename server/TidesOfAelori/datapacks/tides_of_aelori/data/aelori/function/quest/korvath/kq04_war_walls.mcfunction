...
give @s emerald 8
give @s iron_sword[custom_name='{"text":"Item","italic":false}']display:{Name:'{"text":"Korvath Blade","color":"dark_red","italic":false}'},Enchantments:[{id:"minecraft:sharpness",lvl:2}]} 1
