...
give @s emerald 16
give @s diamond 4
give @s iron_sword[custom_name='{"text":"Item","italic":false}']display:{Name:'{"text":"Raider's Edge","color":"red","italic":false}'},Enchantments:[{id:"minecraft:sharpness",lvl:3},{id:"minecraft:knockback",lvl:1}]} 1
