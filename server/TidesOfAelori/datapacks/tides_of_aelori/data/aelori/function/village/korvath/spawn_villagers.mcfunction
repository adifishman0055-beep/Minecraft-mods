...
summon minecraft:villager 985 70 10 {VillagerData:{profession:"cleric",level:5,type:"swamp"},CustomName:'{"text":"Plague Doctor Voss","color":"dark_purple","bold":true}',CustomNameVisible:1b,Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["korvath.npc","korvath.voss"],Offers:{Recipes:[{buy:{id:"minecraft:emerald",count:3},sell:{id:"minecraft:splash_potion",count:1,components:{"minecraft:potion_contents":{potion:"minecraft:strong_harming"}}},maxUses:99},{buy:{id:"minecraft:emerald",count:2},sell:{id:"minecraft:potion",count:1,components:{"minecraft:potion_contents":{potion:"minecraft:strong_healing"}}},maxUses:99},{buy:{id:"minecraft:spider_eye",count:8},sell:{id:"minecraft:emerald",count:1},maxUses:99}]},ArmorItems:[{},{},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":{rgb:4915330}}},{}],HandItems:[{id:"minecraft:brewing_stand",count:1},{}]}

# === BEASTMASTER GHARN — Animal Tamer/Scouts ===
summon minecraft:villager 1025 75 0 {VillagerData:{profession:"butcher",level:5,type:"taiga"},CustomName:'{"text":"Beastmaster Gharn","color":"dark_green","bold":true}',CustomNameVisible:1b,Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["korvath.npc","korvath.gharn"],Offers:{Recipes:[{buy:{id:"minecraft:bone",count:8},sell:{id:"minecraft:wolf_spawn_egg",count:1},maxUses:99},{buy:{id:"minecraft:beef",count:16},sell:{id:"minecraft:emerald",count:2},maxUses:99},{buy:{id:"minecraft:emerald",count:5},sell:{id:"minecraft:saddle",count:1},maxUses:99}]},ArmorItems:[{},{},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":{rgb:5635072}}},{}],HandItems:[{id:"minecraft:bone",count:1},{}]}

# === SPY LYRA — Intelligence/Scouting ===
summon minecraft:villager 990 70 -20 {VillagerData:{profession:"cartographer",level:5,type:"plains"},CustomName:'{"text":"Spy Lyra","color":"dark_aqua","bold":true}',CustomNameVisible:1b,Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["korvath.npc","korvath.lyra"],Offers:{Recipes:[{buy:{id:"minecraft:emerald",count:3},sell:{id:"minecraft:spyglass",count:1},maxUses:99},{buy:{id:"minecraft:emerald",count:5},sell:{id:"minecraft:ender_pearl",count:4},maxUses:99},{buy:{id:"minecraft:paper",count:24},sell:{id:"minecraft:emerald",count:1},maxUses:99}]},ArmorItems:[{},{},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":{rgb:2263842}}},{}],HandItems:[{id:"minecraft:spyglass",count:1},{}]}
